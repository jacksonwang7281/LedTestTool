...
public class RT7216N_BD
{
    ...
    public class PRIMARY_REGISTER
    {
        public int  GBC = 0x3F,
                    READ_SPD = 0,
                    FORCE_CH_PW_ON = 0, //version BA
                    FORCE_SLP_UVLO = 0, //version BA
                    OFF_UVLO = 0,
                    OFF_LOD = 0,
                    OFF_LSD = 0,
                    OFF_SLP = 0,
                    ...
                    OFF_TSD = 0,
                    SRST = 0,
                    tc_r_en = 0,        //version BA
                    temp_update_freq = 0,
                    temp_run_avg_en = 0,
                    pwm_18bit_mode = 0, //version BA
                    TRF = 1,
                    IOHL = 2,
                    DETL = 2,
                    DET = 0;
        ...
        public PRIMARY_REGISTER() {
            options = new option[19];
            options[0] = new option() { name = "GBC", value = GBC, description = "" ,valueDescription = new string[64]};
            options[1] = new option() { name = "READ_SPD", value = READ_SPD, description = "", valueDescription = new string[6] }; 
            options[2] = new option() { name = "FORCE_CH_PW_ON", value = FORCE_CH_PW_ON, description = "", valueDescription = new string[2] };
            options[3] = new option() { name = "FORCE_SLP_UVLO", value = FORCE_SLP_UVLO, description = "", valueDescription = new string[2] };
            options[4] = new option() { name = "OFF_UVLO", value = OFF_UVLO, description = "", valueDescription = new string[2] };
            options[5] = new option() { name = "OFF_LOD", value = OFF_LOD, description = "", valueDescription = new string[2] };
            options[6] = new option() { name = "OFF_LSD", value = OFF_LSD, description = "", valueDescription = new string[2] };
            options[7] = new option() { name = "OFF_SLP", value = OFF_SLP, description = "", valueDescription = new string[2] };
            options[8] = new option() { name = "OFF_WDG", value = OFF_WDG, description = "", valueDescription = new string[2] };
            options[9] = new option() { name = "OFF_TSD", value = OFF_TSD, description = "", valueDescription = new string[2] };
            options[10] = new option() { name = "SRST", value = SRST, description = "", valueDescription = new string[2] };
            options[11] = new option() { name = "tc_r_en", value = tc_r_en, description = "", valueDescription = new string[2] };
            options[12] = new option() { name = "temp_update_freq", value = temp_update_freq, description = "", valueDescription = new string[8] };
            options[13] = new option() { name = "temp_run_avg_en", value = temp_run_avg_en, description = "", valueDescription = new string[2] };
            options[14] = new option() { name = "pwm_18bit_mode", value = pwm_18bit_mode, description = "", valueDescription = new string[2] };
            options[15] = new option() { name = "TRF", value = TRF, description = "", valueDescription = new string[4] };
            options[16] = new option() { name = "IOHL", value = IOHL, description = "", valueDescription = new string[4] };
            options[17] = new option() { name = "DETL", value = DETL, description = "", valueDescription = new string[4] };
            options[18] = new option() { name = "F_DET", value = DET, description = "", valueDescription = new string[4] };

            //options[1].valueDescription[0] = "";
        }
        ...
        public static double idx2temperature(int idx)
        {
            switch (idx)
            {
                ...
                case 48: return 97.3;
                case 49: return 99.7;
                case 50: return 102.0;
                case 51: return 104.4;
                case 52: return 106.7;
                case 53: return 109.1;
                case 54: return 111.4;
                case 55: return 113.8;
                case 56: return 116.1;
                case 57: return 118.4;
                case 58: return 120.8;
                case 59: return 123.1;
                case 60: return 125.5;
                case 61: return 127.8;
                case 62: return 130.2;
                case 63: return 133.0;
                default: return -90;
            }
        ...
        public BitArray toPacket()
        {
            ...
            p[12] = (this.FORCE_CH_PW_ON & 0x01) == 0x01;

            p[16] = (this.FORCE_SLP_UVLO & 0x01) == 0x01;
            p[17] = (this.OFF_UVLO & 0x01) == 0x01;
            ...
            p[36] = (this.pwm_18bit_mode & 0x01) == 0x01;
    ...
    public class MISC
    {
        private int  _tc_g_base       =0;
        private int  _tc_g_gradient   =0;
        private int  _tc_g_en         =0;
        private int  _tc_b_base       =0;
        private int  _tc_b_gradient   =0;
        private int  _tc_b_en         =0;
        private int _read_avg_thm_idx =0;

        public int  tc_g_base           { get{ return _tc_g_base;       } set{_tc_g_base=     limit(value, 255, 0);}}
        public int  tc_g_gradient       { get{ return _tc_g_gradient;   } set{_tc_g_gradient= limit(value, 255, 0);}}
        public int  tc_g_en             { get{ return _tc_g_en;         } set{_tc_g_en=       limit(value, 1, 0);}}
        public int  tc_b_base           { get{ return _tc_b_base;       } set{_tc_b_base=     limit(value, 255, 0);}}
        public int  tc_b_gradient       { get{ return _tc_b_gradient;   } set{_tc_b_gradient= limit(value, 255, 0);}}
        public int  tc_b_en             { get{ return _tc_b_en;         } set{_tc_b_en=       limit(value, 1, 0);}}
        public int read_avg_thm_idx { get { return _read_avg_thm_idx; } set { _read_avg_thm_idx = limit(value, 1, 0); } }
        ...
        public int this[int i]
        {
            get
            {
                switch (i)
                {
                    case 0: return (tc_g_base << 4) + (tc_g_gradient << 12) + (tc_g_en << 20);
                    case 1: return (tc_b_base << 4) + (tc_b_gradient << 12) + (tc_b_en << 20);
                    case 2: return read_avg_thm_idx << 4;
                    default: return 0;
                }
            }
            set
        ...
        public BitArray toPacket(int addr)
        {
            ...
            {
                case 0:
                    p[16] = (tc_g_base & 0x01) == 0x01;
                    p[17] = (tc_g_base & 0x02) == 0x02;
                    p[18] = (tc_g_base & 0x04) == 0x04;
                    p[19] = (tc_g_base & 0x08) == 0x08;
                    p[20] = (tc_g_base & 0x10) == 0x10;
                    p[21] = (tc_g_base & 0x20) == 0x20;
                    p[22] = (tc_g_base & 0x40) == 0x40;
                    p[23] = (tc_g_base & 0x80) == 0x80;
                    p[24] = (tc_g_gradient & 0x01) == 0x01;
                    p[25] = (tc_g_gradient & 0x02) == 0x02;
                    p[26] = (tc_g_gradient & 0x04) == 0x04;
                    p[27] = (tc_g_gradient & 0x08) == 0x08;
                    p[28] = (tc_g_gradient & 0x10) == 0x10;
                    p[29] = (tc_g_gradient & 0x20) == 0x20;
                    p[30] = (tc_g_gradient & 0x40) == 0x40;
                    p[31] = (tc_g_gradient & 0x80) == 0x80;
                    p[32] = (tc_g_en & 0x01) == 0x01;
                    break;
                case 1:
                    p[16] = (tc_b_base & 0x01) == 0x01;
                    p[17] = (tc_b_base & 0x02) == 0x02;
                    p[18] = (tc_b_base & 0x04) == 0x04;
                    p[19] = (tc_b_base & 0x08) == 0x08;
                    p[20] = (tc_b_base & 0x10) == 0x10;
                    p[21] = (tc_b_base & 0x20) == 0x20;
                    p[22] = (tc_b_base & 0x40) == 0x40;
                    p[23] = (tc_b_base & 0x80) == 0x80;
                    p[24] = (tc_b_gradient & 0x01) == 0x01;
                    p[25] = (tc_b_gradient & 0x02) == 0x02;
                    p[26] = (tc_b_gradient & 0x04) == 0x04;
                    p[27] = (tc_b_gradient & 0x08) == 0x08;
                    p[28] = (tc_b_gradient & 0x10) == 0x10;
                    p[29] = (tc_b_gradient & 0x20) == 0x20;
                    p[30] = (tc_b_gradient & 0x40) == 0x40;
                    p[31] = (tc_b_gradient & 0x80) == 0x80;
                    p[32] = (tc_b_en & 0x01) == 0x01;
                    break;
                case 2:
                    p[16] = read_avg_thm_idx == 1;
                    break;
                default: break;
            }
